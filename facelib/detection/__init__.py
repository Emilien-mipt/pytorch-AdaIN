...
def init_retinaface_model(model_name, half=False, device='cuda'):
    ...
    model_path = load_file_from_url(url=model_url, model_dir='models', progress=True, file_name=None)
...
#     model_path = os.path.join('models', list(f_id.keys())[0])
#     if not os.path.exists(model_path):
#         download_pretrained_models(file_ids=f_id, save_path_root='models')
