...
def codeformer(img_path, output_path=''):
    ...
    parser.add_argument('-i', '--input_path', type=str, default=img_path, 
            help='Input image, video or folder. Default: inputs/whole_imgs')
    parser.add_argument('-o', '--output_path', type=str, default='output/codeformer', 
